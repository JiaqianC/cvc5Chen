...
/**
 * Calls yices2 using commandline
 *
 * 
 */
public class Cvc5Com extends SMTEngine {
    ...
    public Cvc5Com(final Arguments arguments) {
        super(arguments);
        this.args = arguments;
    }
    ...
    public Pair<YNM, Map<String, String>> solve(final String smtString, final SMTLogic logic, final Abortion aborter)
        ...
        try {
            ...
            Cvc5Com.LOG.log(Level.FINER, "SMT    to {0}\n", input.getCanonicalPath());

            Cvc5Com.LOG.log(Level.FINER, "Invoking {0}\nyices -e");
            ...
            try {
                ...
                String result = RunCvc5.runCvc(joined);
            ...
            while (it.hasNext()) {
                ...
                Cvc5Com.LOG.log(Level.FINEST, "{0}\n", line);
                //System.err.println("yices-out: " + line);
                if (line.startsWith("unsat")) {
                    Cvc5Com.LOG.log(Level.FINE, "YICES says: UNSAT\n");
                    resType = YNM.NO;
                }
                if (line.startsWith("sat")) {
                    Cvc5Com.LOG.log(Level.FINE, "YICES says: SAT\n");
                    resType = YNM.YES;
                }
                if (line.startsWith("unknown")) {
                    Cvc5Com.LOG.log(Level.FINE, "YICES says: UNKNOWN\n");
                    resType = YNM.MAYBE;
                }
                if (line.startsWith("(")) {
                    if (line.length() < 4) {
            ...
            if (Cvc5Com.LOG.isLoggable(Level.FINE)) {
                Cvc5Com.LOG.fine("SMT solving with Yices took " + (nanos2 - nanos1) / 1000000L + " ms.");
            }
            input.delete();
            aborter.checkAbortion();
