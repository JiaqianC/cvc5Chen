...
/**
 * Calls cvc5 with file
 *
 * 
 */
public class Cvc5File extends SMTEngine {
    ...
    public Cvc5File(final Arguments arguments) {
        super(arguments);
        this.args = arguments;
    }
    ...
    public Pair<YNM, Map<String, String>> solve(final String smtString, final SMTLogic logic, final Abortion aborter)
        ...
        try {
            ...
            Cvc5File.LOG.log(Level.FINER, "SMT    to {0}\n", input.getCanonicalPath());

            Cvc5File.LOG.log(Level.FINER, "Invoking {0}\nyices2 -e");
            ...
            try {
                ...
                cmds.add("--produce-models");
                System.out.println("cvc5 is working");
            ...
            while (it.hasNext()) {
                ...
                Cvc5File.LOG.log(Level.FINEST, "{0}\n", line);
                //System.err.println("yices2-out: " + line);
                if (line.startsWith("unsat")) {
                    Cvc5File.LOG.log(Level.FINE, "YICES 2 says: UNSAT\n");
                    resType = YNM.NO;
                }
                if (line.startsWith("sat")) {
                    Cvc5File.LOG.log(Level.FINE, "YICES 2 says: SAT\n");
                    resType = YNM.YES;
                }
                if (line.startsWith("unknown")) {
                    Cvc5File.LOG.log(Level.FINE, "YICES 2 says: UNKNOWN\n");
                    resType = YNM.MAYBE;
                }
                if (line.startsWith("(")) {
                    if (line.length() < 4) {
            ...
            if (Cvc5File.LOG.isLoggable(Level.FINE)) {
                Cvc5File.LOG.fine("SMT solving with Yices 2 took " + (nanos2 - nanos1) / 1000000L + " ms.");
            }
            input.delete();
            aborter.checkAbortion();
